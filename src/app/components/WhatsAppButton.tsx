...
export function WhatsAppButton() {
  ...
  const whatsappNumber = "2348096691601";
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      {showTooltip && (
        <div
          className="bg-white rounded-lg shadow-xl p-4 max-w-xs relative"
        ...
        >
          ...
          <a
            ...
            className="block w-full py-2 rounded text-center text-sm font-semibold text-white transition-opacity hover:opacity-90"
