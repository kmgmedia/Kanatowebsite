  ...
  return (
    <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {[
            ...
            <div key={i} className="group p-7 rounded-lg border transition-all duration-300 hover:-translate-y-1 hover:shadow-xl cursor-pointer" style={{ borderColor: "#E5E7EB", backgroundColor: "#fff" }}>
              ...
              <h3 className="mb-3" style={{ fontFamily: "Montserrat, sans-serif", fontWeight: 700, color: "#123A6F", fontSize: "1rem" }}>
                {s.title}
              </h3>
      ...
      <div className="mb-6">
        ...
        <div className="rounded-xl p-6" style={{ backgroundColor: "#123A6F", maxWidth: "320px" }}>
          <h3 className="mb-4" style={{ fontFamily: "Montserrat, sans-serif", fontWeight: 700, fontSize: "0.95rem", color: "#fff" }}>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="flex items-start gap-2">
                ...
                <span className="text-xs leading-relaxed" style={{ fontFamily: "Inter, sans-serif", color: "rgba(255,255,255,0.8)" }}>
                  {point}
                </span>
              </div>
            ))}
