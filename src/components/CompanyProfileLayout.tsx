    ...
    >
      ...
      <section
        style={{
          textAlign: "center",
          padding: "80px 40px",
          background: "linear-gradient(to bottom, #004080, #007a33)",
          color: "white",
        }}
      >
        <img
          ...
          alt="Kanato Logo"
          style={{ height: 84, marginBottom: 18 }}
        />
        <h1 style={{ margin: 0 }}>{COMPANY_PROFILE.title}</h1>
        <p style={{ margin: "8px 0 24px", fontSize: 16 }}>
      ...
      >
        ...
        <img
          src={COMPANY_PROFILE.about.image}
      ...
      <section>
        ...
        <p>
          <strong>Vision:</strong> {COMPANY_PROFILE.visionMission.vision}
        </p>
        <p>
          <strong>Mission:</strong> {COMPANY_PROFILE.visionMission.mission}
        </p>
        ...
        >
          {COMPANY_PROFILE.projects.map((proj, i) => (
            ...
            >
              ...
              <p style={{ margin: 0 }}>
                {proj.client} — {proj.location} ({proj.year})
              </p>
            </div>
          ))}
        </div>
      ...
      <section style={{ marginTop: 40, marginBottom: 60 }}>
        <h2>Contact Us</h2>
        <p>
          <strong>Head Office:</strong> {COMPANY_PROFILE.contact.headOffice}
        </p>
        <p>
          <strong>Branch Office:</strong> {COMPANY_PROFILE.contact.branchOffice}
        </p>
        <p>
          <strong>Phone:</strong> {COMPANY_PROFILE.contact.phone.join(", ")}
        </p>
        <p>
          <strong>Email:</strong> {COMPANY_PROFILE.contact.email}
        </p>
      </section>
    </div>
  );
